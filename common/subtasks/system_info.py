...
SYSTEM_INFO_RESULT_DEF = SubtaskResultDefinition(
    name="get_system_info",
    description="Returns comprehensive system information including OS, Python, and hardware details",
    result_type="object",
    required_fields=["hostname", "os", "python", "timestamp"],
    is_critical=False,
    format_hint="Dictionary with nested system details including OS, Python version, and optional hardware info"
)


@register_subtask('get_system_info', SYSTEM_INFO_RESULT_DEF)
def get_system_info() -> Dict[str, Any]:
    ...
    Example:
        ...
        >>> print(result['result']['os']['system'])  # 'Windows' or 'Linux'
        >>> print(result['result']['python']['version'])  # '3.13.0'
    """
    try:
